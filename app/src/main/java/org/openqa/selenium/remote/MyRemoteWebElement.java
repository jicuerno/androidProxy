...
public class MyRemoteWebElement implements WebElement, FindsByLinkText, FindsById, FindsByName,
        FindsByTagName, FindsByClassName, FindsByCssSelector,
        FindsByXPath, WrapsDriver, Locatable, HasIdentity,
        TakesScreenshot {
    private String foundBy;
    protected String id;
    protected MyRemoteWebDriver parent;
    ...
    public void setParent(MyRemoteWebDriver parent) {
        this.parent = parent;
            ...
            public Point inViewPort() {
                if (parent.getW3CStandardComplianceLevel() == 0) {
                    ...
                    Map<String, Number> mapped = (Map<String, Number>) parent.executeScript(
                            "return arguments[0].getBoundingClientRect()", MyRemoteWebElement.this);
