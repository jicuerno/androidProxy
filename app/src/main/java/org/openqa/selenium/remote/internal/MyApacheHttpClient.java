...
public class MyApacheHttpClient implements org.openqa.selenium.remote.http.HttpClient {
    ...
    public MyApacheHttpClient(HttpClient client, URL url) {
    ...
    public static class Factory implements org.openqa.selenium.remote.http.HttpClient.Factory {
        ...
        private static MyHttpClientFactory defaultClientFactory;

        private final MyHttpClientFactory clientFactory;

        public Factory() {
            this(getDefaultHttpClientFactory());
        }

        public Factory(MyHttpClientFactory clientFactory) {
        ...
        private static synchronized MyHttpClientFactory getDefaultHttpClientFactory() {
            if (defaultClientFactory == null) {
                defaultClientFactory = new MyHttpClientFactory();
            }
