...
import net.lightbody.bmp.mitm.util.MyEncryptionUtil;
...
public class MyRootCertificateGenerator implements CertificateAndKeySource {
    ...
    public MyRootCertificateGenerator(CertificateInfo rootCertificateInfo,
    ...
    public void saveRootCertificateAsPemFile(File file) {
        ...
        MyEncryptionUtil.writePemStringToFile(file, pemEncodedCertificate);
    }
    ...
    public void savePrivateKeyAsPemFile(File file, String passwordForPrivateKey) {
        ...
        MyEncryptionUtil.writePemStringToFile(file, pemEncodedPrivateKey);
    }
    ...
    /**
     * Convenience method to return a new {@link RootCertificateGenerator.Builder} instance.
     */
    public static MyRootCertificateGenerator.Builder builder() {
        return new MyRootCertificateGenerator.Builder();
    }
    ...
    public static class Builder {
         ...
         */
        public MyRootCertificateGenerator.Builder certificateInfo(CertificateInfo certificateInfo) {
         ...
         */
        public MyRootCertificateGenerator.Builder keyGenerator(KeyGenerator keyGenerator) {
            this.keyGenerator = keyGenerator;
            return this;
        }
         ...
         */
        public MyRootCertificateGenerator.Builder messageDigest(String messageDigest) {
            this.messageDigest = messageDigest;
            return this;
        }
         ...
         */
        public MyRootCertificateGenerator.Builder certificateTool(SecurityProviderTool securityProviderTool) {
            this.securityProviderTool = securityProviderTool;
            return this;
        }

        public MyRootCertificateGenerator build() {
            return new MyRootCertificateGenerator(certificateInfo, messageDigest, keyGenerator, securityProviderTool);
        }
    }
